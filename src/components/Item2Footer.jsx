...
function Item2Footer({ price, priceOnWarf }) {
  return (
    <div className="fontOpen flex justify-between items-center mt-[35px] mb-[19px] mx-[19px] desktop:justify-start">
      ...
      <a
        ...
        className="font-semibold text-[14px] text-[#404040] leading-[20px] flex justify-center items-center w-[193px] h-[44px] bg-[#FED74B] rounded-[10px] desktop:ml-[8px] desktop:bg-[#FFD83C] desktop:text-[18px] desktop:font-normal desktop:text-[#292929]"
      >
        Подробнее
      </a>
    </div>
